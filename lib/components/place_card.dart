...
import 'package:travel/models/FeedSpot.dart';
import 'package:travel/models/HotelSpot.dart';
import 'package:travel/models/LocaleSpot.dart';
...
class FeedCard extends StatelessWidget {
  const FeedCard({
    Key key,
    @required this.feedSport,
    this.isFullCard = false,
    @required this.press,
  }) : super(key: key);


  final FeedSpot feedSport;
  final bool isFullCard;
  final GestureTapCallback press;
          ...
          AspectRatio(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: AssetImage(feedSport.image), fit: BoxFit.cover),
              ),
            ),
          ),
          Container(
...
class Feeders extends StatelessWidget {
  ...
  ClipOval buildFeederFace(int index) {
    return ClipOval(
      // child: Image.asset(
      //   // users[index].image,
      //   height: getProportionateScreenWidth(28),
...
class LocaleCard extends StatelessWidget {
  const LocaleCard({
    Key key,
    @required this.localeSport,
    this.isFullCard = false,
    @required this.press,
  }) : super(key: key);


  final LocaleSpot localeSport;
  final bool isFullCard;
  final GestureTapCallback press;
          ...
          AspectRatio(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: AssetImage(localeSport.image), fit: BoxFit.cover),
              ),
            ),
          ),
          Container(
...
class Localers extends StatelessWidget {
  const Localers({
    Key key,
    // @required this.users,
  }) : super(key: key);
  ...
  ClipOval buildLocalerFace(int index) {
    return ClipOval(
      // child: Image.asset(
      //   // users[index].image,
      //   height: getProportionateScreenWidth(28),
